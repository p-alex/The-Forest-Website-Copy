...
if exist "League of Legends.exe" (
	@start "" "League of Legends.exe" "8394" "LoLLauncher.exe" "" "spectator spectator.euw1.lol.riotgames.com:80 5DSJSQPfE8lWmOKKlWfcBLBpR2PKmaSs 3839793804 EUW1" "-UseRads" "-Locale=%locale%"
	goto :eof
)
:cannotFind
echo ===================
